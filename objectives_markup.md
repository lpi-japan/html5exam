...
- [1. HTML/CSS Level 1 出題範囲](#1-htmlcss-level-1-出題範囲)
  - [1.1. HTML](#11-html)
    ...
    - [1.1.4. Emojiの使用 (重要度: 2)](#114-emojiの使用-重要度-2)
  - [1.2. 要素](#12-要素)
...
- [2. HTML/CSS Level 2 出題範囲](#2-htmlcss-level-2-出題範囲)
  - [2.1. 高度なHTML](#21-高度なhtml)
    - [2.1.1. セマンティクスの深堀り (重要度: 8)](#211-セマンティクスの深堀り-重要度-8)
    - [2.1.2. 高度なメディア要素 (重要度: 6)](#212-高度なメディア要素-重要度-6)
    - [2.1.3. インタラクティブ要素の応用 (重要度: 4)](#213-インタラクティブ要素の応用-重要度-4)
    - [2.1.4. アクセシビリティ応用 (重要度: 6)](#214-アクセシビリティ応用-重要度-6)
  - [2.2. 高度なCSS](#22-高度なcss)
    ...
    - [2.2.6. 可変フォント(Variable Fonts) (重要度: 2)](#226-可変フォントvariable-fonts-重要度-2)
...
### 2.2.6. 可変フォント(Variable Fonts) (重要度: 2)
