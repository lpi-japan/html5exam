...
- [1. Web プロフェッショナルマークアップ Level 1 試験 出題範囲](#1-web-プロフェッショナルマークアップ-level-1-試験-出題範囲)
  ...
  - [1.3. CSSの基礎](#13-cssの基礎)
    ...
    - [1.3.2. カスケードと継承 / 旧 1.2.3 (重要度: 5)](#132-カスケードと継承--旧-123-重要度-5)
...
### 1.3.2. カスケードと継承 / 旧 1.2.3 (重要度: 5)
出題種別: 知識問題、コードリーディング問題、記述問題

<!-- TODO: 旧 1.2.3 は重要度2なので、内容が変わらなければ再考 (継承がなかったので追加した) -->
...
<!-- TODO: 継承の追加ネタとして allプロパティ、inherit、revert、などがここでだせる？ -->
