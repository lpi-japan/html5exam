...
- [2. HTML/CSS Level 2 出題範囲](#2-htmlcss-level-2-出題範囲)
  ...
  - [2.2. 高度なCSS](#22-高度なcss)
    ...
    - [2.2.3. カスタムプロパティと関数 (重要度: 4)](#223-カスタムプロパティと関数-重要度-4)
    - [2.2.4. アニメーションとトランジション (重要度: 4)](#224-アニメーションとトランジション-重要度-4)
    - [2.2.5. CSSパフォーマンス最適化 (重要度: 4)](#225-cssパフォーマンス最適化-重要度-4)
    - [2.2.6. Webフォントと可変フォント (重要度: 2)](#226-webフォントと可変フォント-重要度-2)
    - [2.2.7. CSSネスティング (重要度: 3)](#227-cssネスティング-重要度-3)
    - [2.2.8. コンテナクエリ (重要度: 3)](#228-コンテナクエリ-重要度-3)
    - [2.2.9. 印刷スタイル](#229-印刷スタイル)
    - [2.2.10. CSSカプセル化とShadow DOM (重要度: \[検討が必要\])](#2210-cssカプセル化とshadow-dom-重要度-検討が必要)
  - [2.3. Webセキュリティとベストプラクティス](#23-webセキュリティとベストプラクティス)
...
#### 概要
- `@page` ルールや改ページ制御プロパティを利用して、印刷に適したレイアウトやスタイルを適用できる。
...
- 印刷時の要素の表示/非表示制御
- リンク URL の表示など、印刷特有のスタイル調整

### 2.2.10. CSSカプセル化とShadow DOM (重要度: [検討が必要])
...
## 2.3. Webセキュリティとベストプラクティス

### 2.3.1. フロントエンドセキュリティ対策
出題種別: 知識問題、コードリーディング問題
