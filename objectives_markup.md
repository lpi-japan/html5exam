...
- [Web プロフェッショナルマークアップ Level 1 試験 出題範囲](#web-プロフェッショナルマークアップ-level-1-試験-出題範囲)
  ...
  - [2. 要素](#2-要素)
    ...
    - [2.2. メディア要素 (重要度: 2) / 旧 1.3.2](#22-メディア要素-重要度-2--旧-132)
    - [2.3. インタラクティブ要素 (重要度: 2) / 旧 1.3.3](#23-インタラクティブ要素-重要度-2--旧-133)
  ...
  - [4. CSSデザイン](#4-cssデザイン)
    ...
    - [4.2. インタラクション (重要度: 3)](#42-インタラクション-重要度-3)
    - [4.3. 色と背景 (重要度: 3) / 旧 1.2.2](#43-色と背景-重要度-3--旧-122)
    - [4.4. テキスト、リスト、テーブル (重要度: 4) / 旧 1.2.2](#44-テキストリストテーブル-重要度-4--旧-122)
    - [4.5. 変形とアニメーション (重要度: 2)](#45-変形とアニメーション-重要度-2)
  - [5. レスポンシブWebデザイン](#5-レスポンシブwebデザイン)
    - [5.1. マルチデバイス対応 (重要度: 3) / 旧 1.4.1](#51-マルチデバイス対応-重要度-3--旧-141)
    - [5.2. メディアクエリ (重要度: 3) / 旧 1.4.2](#52-メディアクエリ-重要度-3--旧-142)
    - [5.3. フレックスボックスとCSS Gridの基礎 (重要度: 3)](#53-フレックスボックスとcss-gridの基礎-重要度-3)
...
- フォームによる送信の宣言的な指定（`method`、`action`、`enctype`）は 2.3 節の範囲とする。
...
### 2.3. インタラクティブ要素 (重要度: 2) / 旧 1.3.3
出題種別: 知識問題、コードリーディング問題、記述問題  

#### 概要
- フォーム要素やインタラクティブ要素の**宣言的な記述**（要素・属性・HTML レベルのイベント）を理解し、適切に使用できる。
- 入力制御や送信のプログラム的な操作はプログラミング試験（7 節）の範囲とする。
...
### 4.4. テキスト、リスト、テーブル (重要度: 4) / 旧 1.2.2
出題種別: 知識問題、コードリーディング問題、記述問題

#### 概要
- テキスト、リスト、テーブルのスタイル設定の基礎を理解する。
- Web フォントの読み込み・表示制御は、メディアの配信最適化（2.2 節）の観点からも扱う。
...
### 4.5. 変形とアニメーション (重要度: 2)
出題種別: 知識問題、コードリーディング問題、記述問題

#### 概要
- キーフレームを用いたアニメーションの概念を理解し、シンプルなエフェクトを実装できる。
- 基本的なトランジションは 4.2 節で扱う。
...
### 5.3. フレックスボックスとCSS Gridの基礎 (重要度: 3)
出題種別: 知識問題、コードリーディング問題、記述問題  
