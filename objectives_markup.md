...
- [2. Web プロフェッショナルマークアップ Level 2 試験 出題範囲](#2-web-プロフェッショナルマークアップ-level-2-試験-出題範囲)
  ...
  - [2.4. Webセキュリティとベストプラクティス](#24-webセキュリティとベストプラクティス)    - [2.4.1 フロントエンドセキュリティ対策 (重要度: 4)](#241-フロントエンドセキュリティ対策-重要度-4)
...
### 2.3.1. カスタムプロパティと関数 (重要度: 4)出題種別: 知識問題、コードリーディング問題、記述問題
...
### 2.3.5. カスケードキーワードの使い分け (重要度: 2)出題種別: 知識問題、コードリーディング問題
