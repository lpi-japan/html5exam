...
## 確認できるスキルレベル（移設・未整理） <!-- omit in toc -->

### マークアップ Level 2

複雑なマークアップとスタイルの設計において、複数の手法を比較し、品質・パフォーマンス・アクセシビリティへの影響を踏まえて選択できる。
...
実践的な Web 機能の要件に対して、API や実装手法を比較し設計判断ができる。

- モジュール分割の目的を理解しコードベースの設計に活かせる。
- Node.js とパッケージマネージャーを用いたフロントエンド開発のコードベースを構築できる。
- マルチメディア・アニメーションなど動的コンテンツの要件に対して、適切な API を選択して実装できる。
...
### 2.2.2. History API (重要度: 2) / 旧 2.2.5
出題種別: 知識問題、コードリーディング問題、記述問題
...
### 2.4.1. メディア要素のAPI (重要度: 2) / 旧 2.4.1
出題種別: 知識問題、コードリーディング問題、記述問題
...
### 2.5.1. Web Storage (重要度: 2) / 旧 2.5.1
出題種別: 知識問題、コードリーディング問題、記述問題
...
### 2.5.2. Indexed Database API (重要度: 2) / 旧 2.5.2
出題種別: 知識問題、コードリーディング問題、記述問題
...
### 2.5.4. バイナリーデータと形式変換 (重要度: 1) / 旧 2.5.4
出題種別: 知識問題、コードリーディング問題、記述問題
...
### 2.6.3. Server-Sent Events (重要度: 1) / 旧 2.6.3
出題種別: 知識問題、コードリーディング問題、記述問題
...
### 2.7.1. Web Workers (重要度: 2) / 旧 2.8.1
出題種別: 知識問題、コードリーディング問題、記述問題
...
### 2.7.2. Service Worker (重要度: 2) / 旧 2.8.3
出題種別: 知識問題、コードリーディング問題、記述問題
...
### 2.8.1. パフォーマンスタイミングAPI (重要度: 2) / 旧 2.8.2
出題種別: 知識問題、コードリーディング問題、記述問題
...
### 2.8.2. ナビゲーションとリソースタイミング (重要度: 2) / 旧 2.8.5
出題種別: 知識問題、コードリーディング問題、記述問題
...
### 2.8.3. Page Visibility (重要度: 2) / 旧 2.8.4
出題種別: 知識問題、コードリーディング問題、記述問題
...
### 2.9.1. クロスオリジン制約とCORS (重要度: 2) / 旧 2.9.1
出題種別: 知識問題、コードリーディング問題、記述問題
...
### 2.9.2. セキュリティモデルとSSLの関係 (重要度: 2) / 旧 2.9.2
出題種別: 知識問題、コードリーディング問題、記述問題
