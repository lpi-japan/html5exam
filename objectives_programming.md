...
- [2. JavaScript Level 2 出題範囲](#2-javascript-level-2-出題範囲)
  ...
  - [2.8. オフラインAPI](#28-オフラインapi)
    - [2.8.1. Web Workers (重要度: 2)](#281-web-workers-重要度-2)
    - [2.8.2. Service Worker (重要度: 2)](#282-service-worker-重要度-2)
    - [2.8.3. Page Visibility (重要度: 2)](#283-page-visibility-重要度-2)
  - [2.9. パフォーマンスAPI](#29-パフォーマンスapi)
    - [2.9.1. パフォーマンスタイミングAPI (重要度: 2)](#291-パフォーマンスタイミングapi-重要度-2)
    - [2.9.2. ナビゲーションとリソースタイミング (重要度: 2)](#292-ナビゲーションとリソースタイミング-重要度-2)
