...
- [1. Web プロフェッショナルプログラミング Level 1 試験 出題範囲](#1-web-プロフェッショナルプログラミング-level-1-試験-出題範囲)
  ...
  - [1.7 イベント・フォーム・ウィンドウの操作](#17-イベント・フォーム・ウィンドウの操作)
  ...
  - [1.8 APIの基礎知識](#18-apiの基礎知識)
    - [1.8.1. マルチメディア・グラフィックス系API (重要度: 2) / 旧 1.5.1](#181-マルチメディア・グラフィックス系api-重要度-2-旧-151)
    - [1.8.2. メディアキャプチャAPIとデバイス権限 (重要度: 2) / 旧 1.5.2](#182-メディアキャプチャapiとデバイス権限-重要度-2-旧-152)
    - [1.8.3. オフライン・ストレージ系API (重要度: 2) / 旧 1.5.3](#183-オフライン・ストレージ系api-重要度-2-旧-153)
...
- [2. Web プロフェッショナルプログラミング Level 2 試験 出題範囲](#2-web-プロフェッショナルプログラミング-level-2-試験-出題範囲)
  - [2.1 高度なJavaScript](#21-高度なjavascript)
    ...
    - [2.1.3. 高度な非同期・平行パターン (重要度: 2)](#213-高度な非同期・平行パターン-重要度-2)
  - [2.2 WebブラウザにおけるJavaScript API](#22-webブラウザにおけるjavascript-api)
    - [2.2.1. DOM応用 (重要度: 3) / 旧 2.2.2](#221-dom応用-重要度-3-旧-222)
    - [2.2.2. History API (重要度: 2) / 旧 2.2.5](#222-history-api-重要度-2-旧-225)
    - [2.2.3. Webコンポーネント (重要度: 2)](#223-webコンポーネント-重要度-2)
  - [2.3 グラフィックス・アニメーション / 旧 1.5.1](#23-グラフィックス・アニメーション-旧-151)
    - [2.3.1. Canvas(2D) (重要度: 3) / 旧 2.3.1](#231-canvas-2d-重要度-3-旧-231)
    - [2.3.2. SVG (重要度: 2) / 旧 2.3.2](#232-svg-重要度-2-旧-232)
    - [2.3.3. Timing control for script-based animations (重要度: 2) / 旧 2.3.3](#233-timing-control-for-script-based-animations-重要度-2-旧-233)
  - [2.4 マルチメディア / 旧 1.5.1](#24-マルチメディア-旧-151)
    - [2.4.1. メディア要素のAPI (重要度: 2) / 旧 2.4.1](#241-メディア要素のapi-重要度-2-旧-241)
  - [2.5 ストレージ / 旧 1.5.3](#25-ストレージ-旧-153)
    - [2.5.1. Web Storage (重要度: 2) / 旧 2.5.1](#251-web-storage-重要度-2-旧-251)
    - [2.5.2. Indexed Database API (重要度: 2) / 旧 2.5.2](#252-indexed-database-api-重要度-2-旧-252)
    - [2.5.3. File API (重要度: 2) / 旧 2.5.3](#253-file-api-重要度-2-旧-253)
    - [2.5.4. バイナリーデータと形式変換 (重要度: 1) / 旧 2.5.4](#254-バイナリーデータと形式変換-重要度-1-旧-254)
  - [2.6 通信・位置情報API / 旧 1.5.4](#26-通信・位置情報api-旧-154)
    - [2.6.1. WebSocket (重要度: 2) / 旧 2.6.1](#261-websocket-重要度-2-旧-261)
    - [2.6.2. Fetch APIによる詳細な通信制御 (重要度: 2)](#262-fetch-apiによる詳細な通信制御-重要度-2)
    - [2.6.3. Server-Sent Events (重要度: 1) / 旧 2.6.3](#263-server-sent-events-重要度-1-旧-263)
    - [2.6.4. Geolocation API / 旧 2.7.1](#264-geolocation-api-旧-271)
  - [2.7 オフラインAPI](#27-オフラインapi)
    - [2.7.1. Web Workers (重要度: 2) / 旧 2.8.1](#271-web-workers-重要度-2-旧-281)
    - [2.7.2. Service Worker (重要度: 2) / 旧 2.8.3](#272-service-worker-重要度-2-旧-283)
  - [2.8 パフォーマンスAPI](#28-パフォーマンスapi)
    - [2.8.1. パフォーマンスタイミングAPI (重要度: 2) / 旧 2.8.2](#281-パフォーマンスタイミングapi-重要度-2-旧-282)
    - [2.8.2. ナビゲーションとリソースタイミング (重要度: 2) / 旧 2.8.5](#282-ナビゲーションとリソースタイミング-重要度-2-旧-285)
    - [2.8.3. Page Visibility (重要度: 2) / 旧 2.8.4](#283-page-visibility-重要度-2-旧-284)
  - [2.9 セキュリティ](#29-セキュリティ)
    - [2.9.1. クロスオリジン制約とCORS (重要度: 2) / 旧 2.9.1](#291-クロスオリジン制約とcors-重要度-2-旧-291)
    - [2.9.2. セキュリティモデルとSSLの関係 (重要度: 2) / 旧 2.9.2](#292-セキュリティモデルとsslの関係-重要度-2-旧-292)
...
### 1.4.1. 繰り返しと時間指定実行 (重要度: 2) / 旧 2.2.3 (一部)出題種別: 知識問題、コードリーディング問題、記述問題
#### 概要
...
### 1.6.1. DOM の基本操作 (重要度: 2) / 旧 2.2.2出題種別: 知識問題、コードリーディング問題、記述問題
#### 概要
...
### 1.6.2. Selectors API (重要度: 2) / 旧 2.2.4出題種別: 知識問題、コードリーディング問題、記述問題
#### 概要
...
### 1.7.1. イベントの基本 (重要度: 2) / 旧 2.2.1出題種別: 知識問題、コードリーディング問題、記述問題
#### 概要
...
### 1.7.2. フォームの操作とバリデーション (重要度: 2) / 旧 2.2.2 (一部)出題種別: 知識問題、コードリーディング問題、記述問題
#### 概要
- フォーム入力値の取得と検証ができる
...
### 1.7.3. 基本的なウィンドウ操作 (重要度: 2) / 旧 2.2.3 (一部)出題種別: 知識問題、コードリーディング問題、記述問題
#### 概要
...
### 1.8.1. マルチメディア・グラフィックス系API (重要度: 2) / 旧 1.5.1出題種別: 知識問題、コードリーディング問題、記述問題
#### 概要
...
### 1.8.2. メディアキャプチャAPIとデバイス権限 (重要度: 2) / 旧 1.5.2出題種別: 知識問題、記述問題
#### 概要
...
### 1.8.3. オフライン・ストレージ系API (重要度: 2) / 旧 1.5.3出題種別: 知識問題、記述問題
#### 概要
...
### 1.8.4. 通信系API (重要度: 2) / 旧 1.5.4出題種別: 知識問題、コードリーディング問題、記述問題
#### 概要
- サーバーとの非同期通信（Ajax）を実現する Fetch API の基本的な仕組みと活用方法を理解する。
...
### 2.2.1. DOM応用 (重要度: 3) / 旧 2.2.2出題種別: 知識問題、コードリーディング問題、記述問題
#### 概要
...
### 2.2.2. History API (重要度: 2) / 旧 2.2.5出題種別: 知識問題、コードリーディング問題、記述問題
#### 概要
...
### 2.3.1. Canvas(2D) (重要度: 3) / 旧 2.3.1出題種別: 知識問題、コードリーディング問題、記述問題
#### 概要
...
### 2.3.2. SVG (重要度: 2) / 旧 2.3.2出題種別: 知識問題、コードリーディング問題、記述問題
#### 概要
...
### 2.3.3. Timing control for script-based animations (重要度: 2) / 旧 2.3.3出題種別: 知識問題、コードリーディング問題、記述問題
#### 概要
...
### 2.4.1. メディア要素のAPI (重要度: 2) / 旧 2.4.1出題種別: 知識問題、コードリーディング問題、記述問題
#### 概要
...
### 2.5.1. Web Storage (重要度: 2) / 旧 2.5.1出題種別: 知識問題、コードリーディング問題、記述問題
#### 概要
...
### 2.5.2. Indexed Database API (重要度: 2) / 旧 2.5.2出題種別: 知識問題、コードリーディング問題、記述問題
#### 概要
...
### 2.5.3. File API (重要度: 2) / 旧 2.5.3出題種別: 知識問題、コードリーディング問題、記述問題
#### 概要
...
### 2.5.4. バイナリーデータと形式変換 (重要度: 1) / 旧 2.5.4出題種別: 知識問題、コードリーディング問題、記述問題
#### 概要
...
### 2.6.1. WebSocket (重要度: 2) / 旧 2.6.1出題種別: 知識問題、コードリーディング問題、記述問題
#### 概要
...
### 2.6.3. Server-Sent Events (重要度: 1) / 旧 2.6.3出題種別: 知識問題、コードリーディング問題、記述問題
#### 概要
...
### 2.7.1. Web Workers (重要度: 2) / 旧 2.8.1出題種別: 知識問題、コードリーディング問題、記述問題
#### 概要
...
### 2.7.2. Service Worker (重要度: 2) / 旧 2.8.3出題種別: 知識問題、コードリーディング問題、記述問題
#### 概要
...
### 2.8.1. パフォーマンスタイミングAPI (重要度: 2) / 旧 2.8.2出題種別: 知識問題、コードリーディング問題、記述問題
#### 概要
...
### 2.8.2. ナビゲーションとリソースタイミング (重要度: 2) / 旧 2.8.5出題種別: 知識問題、コードリーディング問題、記述問題
#### 概要
...
### 2.8.3. Page Visibility (重要度: 2) / 旧 2.8.4出題種別: 知識問題、コードリーディング問題、記述問題
#### 概要
...
### 2.9.1. クロスオリジン制約とCORS (重要度: 2) / 旧 2.9.1出題種別: 知識問題、コードリーディング問題、記述問題
#### 概要
...
### 2.9.2. セキュリティモデルとSSLの関係 (重要度: 2) / 旧 2.9.2出題種別: 知識問題、コードリーディング問題、記述問題
#### 概要
