...
- [1. JavaScript Level 1 出題範囲](#1-javascript-level-1-出題範囲)
  ...
  - [1.6. イベント・フォーム・ウィンドウの操作](#16-イベントフォームウィンドウの操作)
    ...
    - [1.7.1. 基本的なウィンドウ操作 / 2.2.3 (一部)](#171-基本的なウィンドウ操作--223-一部)
  - [1.8. デバッグとテスト](#18-デバッグとテスト)
    - [1.8.1. デバッグの基本](#181-デバッグの基本)
    - [1.8.2. テストの基本](#182-テストの基本)
  - [1.9. APIの基礎知識](#19-apiの基礎知識)
    - [1.9.1. マルチメディア・グラフィックス系API / 1.5.1](#191-マルチメディアグラフィックス系api--151)
    - [1.9.2. デバイスアクセス系API / 1.5.2](#192-デバイスアクセス系api--152)
    - [1.9.3. オフライン・ストレージ系API / 1.5.3](#193-オフラインストレージ系api--153)
    - [1.9.4. 通信系API / 1.5.4](#194-通信系api--154)
- [2. JavaScript Level 2 出題範囲](#2-javascript-level-2-出題範囲)
  ...
  - [2.2. パフォーマンスと最適化](#22-パフォーマンスと最適化)
    - [2.2.1. パフォーマンス測定](#221-パフォーマンス測定)
    - [2.2.2. コードの最適化](#222-コードの最適化)
  - [2.3. WebブラウザにおけるJavaScript API](#23-webブラウザにおけるjavascript-api)
    - [2.3.1. DOM応用 / 2.2.2](#231-dom応用--222)
    - [2.3.3. History API / 2.2.5](#233-history-api--225)
...
### 1.9.1. マルチメディア・グラフィックス系API / 1.5.1
出題種別: 知識問題、コードリーディング問題、記述問題
