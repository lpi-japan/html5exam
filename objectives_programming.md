...
- [1. JavaScript Level 1 出題範囲](#1-javascript-level-1-出題範囲)
  ...
  - [1.8. APIの基礎知識](#18-apiの基礎知識)
    - [1.8.1. マルチメディア・グラフィックス系API](#181-マルチメディアグラフィックス系api)
    - [1.8.2. デバイスアクセス系API概要](#182-デバイスアクセス系api概要)
    - [1.8.3. オフライン・ストレージ系API](#183-オフラインストレージ系api)
    - [1.8.4. 通信系API](#184-通信系api)
