...
- [1. JavaScript Level 1 出題範囲](#1-javascript-level-1-出題範囲)
  - [1.1. JavaScriptの基礎 / 2.1.1](#11-javascriptの基礎--211)
  ...
  - [1.2. 制御構文](#12-制御構文)
    ...
    - [1.2.2. ループ](#122-ループ)
    - [1.2.3. 例外処理](#123-例外処理)
  - [1.3. オブジェクトとクラス / 2.1.2](#13-オブジェクトとクラス--212)
    - [1.3.1. オブジェクトとプロパティ](#131-オブジェクトとプロパティ)
    - [1.3.2. クラスとインスタンス](#132-クラスとインスタンス)
  - [1.4. 非同期処理](#14-非同期処理)
    - [1.4.1. 繰り返しと時間指定実行 / 2.2.3 (一部)](#141-繰り返しと時間指定実行--223-一部)
    - [1.4.2. Promise, async/await](#142-promise-asyncawait)
  - [1.5. DOM操作](#15-dom操作)
    - [1.5.1. DOM の基本操作 / 2.2.2](#151-dom-の基本操作--222)
    - [1.5.2. Selectors API / 2.2.4](#152-selectors-api--224)
  - [1.6. イベント・フォーム・ウィンドウの操作](#16-イベントフォームウィンドウの操作)
    - [1.6.1. イベントの基本 / 2.2.1](#161-イベントの基本--221)
    - [1.6.2. フォームの操作とバリデーション / 2.2.2 (一部)](#162-フォームの操作とバリデーション--222-一部)
    - [1.6.3. 基本的なウィンドウ操作 / 2.2.3 (一部)](#163-基本的なウィンドウ操作--223-一部)
  - [1.7. デバッグとテスト](#17-デバッグとテスト)
    - [1.7.1. デバッグの基本](#171-デバッグの基本)
    - [1.7.2. テストの基本](#172-テストの基本)
  - [1.8. APIの基礎知識](#18-apiの基礎知識)
    - [1.8.1. マルチメディア・グラフィックス系API / 1.5.1](#181-マルチメディアグラフィックス系api--151)
    - [1.8.2. デバイスアクセス系API / 1.5.2](#182-デバイスアクセス系api--152)
    - [1.8.3. オフライン・ストレージ系API / 1.5.3](#183-オフラインストレージ系api--153)
    - [1.8.4. 通信系API / 1.5.4](#184-通信系api--154)
- [2. JavaScript Level 2 出題範囲](#2-javascript-level-2-出題範囲)
  - [2.1. 高度なJavaScript](#21-高度なjavascript)
    ...
    - [2.1.2. パフォーマンス測定と最適化](#212-パフォーマンス測定と最適化)
    - [2.1.3. コードの最適化](#213-コードの最適化)
  - [2.2. WebブラウザにおけるJavaScript API](#22-webブラウザにおけるjavascript-api)
    - [2.2.1. DOM応用 / 2.2.2](#221-dom応用--222)
    - [2.2.2. History API / 2.2.5](#222-history-api--225)
  - [2.3. グラフィックス・アニメーション / 1.5.1](#23-グラフィックスアニメーション--151)
    - [2.3.1. Canvas(2D) / 2.3.1](#231-canvas2d--231)
    - [2.3.2. SVG / 2.3.2](#232-svg--232)
  - [2.4. グラフィックス・アニメーション / 1.5.1](#24-グラフィックスアニメーション--151)
    - [2.4.1. Canvas(2D) / 2.3.1](#241-canvas2d--231)
    - [2.4.2. SVG / 2.3.2](#242-svg--232)
    - [2.4.3. Timing control for script-based animations / 2.3.3](#243-timing-control-for-script-based-animations--233)
  - [2.5. マルチメディア / 1.5.1](#25-マルチメディア--151)
    - [2.5.1. メディア要素のAPI / 2.4.1](#251-メディア要素のapi--241)
    - [2.5.2. DeviceOrientation Event / 2.7.2](#252-deviceorientation-event--272)
  - [2.6. ストレージ / 1.5.3](#26-ストレージ--153)
    - [2.6.1. Web Storage / 2.5.1](#261-web-storage--251)
    - [2.6.2. Indexed Database API / 2.5.2](#262-indexed-database-api--252)
    - [2.6.3. File API / 2.5.3](#263-file-api--253)
    - [2.6.4. バイナリーデータ / 2.5.4](#264-バイナリーデータ--254)
  - [2.7. 通信　/ 1.5.4](#27-通信-154)
    - [2.7.1. WebSocket / 2.6.1](#271-websocket--261)
    - [2.7.2. XMLHttpRequest / 2.6.2](#272-xmlhttprequest--262)
    - [2.7.3. Server-Sent Events / 2.6.3](#273-server-sent-events--263)
  - [2.8. デバイスアクセス / 1.5.2](#28-デバイスアクセス--152)
    - [2.8.1. Geolocation API / 2.7.1](#281-geolocation-api--271)
    - [2.8.2. DeviceOrientation Event / 2.7.2](#282-deviceorientation-event--272)
  - [2.9. パフォーマンスとオフライン /　1.5.3](#29-パフォーマンスとオフライン-153)
    - [2.9.1. Web Workers / 2.8.1](#291-web-workers--281)
    - [2.9.2. High Resolution Time / 2.8.2](#292-high-resolution-time--282)
    - [2.9.3. Service Workerによるオフラインアプリケーション / 2.8.3](#293-service-workerによるオフラインアプリケーション--283)
    - [2.9.4. Page Visibility / 2.8.4](#294-page-visibility--284)
    - [2.9.5. Navigation Timing / 2.8.5](#295-navigation-timing--285)
  - [2.10. セキュリティ](#210-セキュリティ)
    - [2.10.1. クロスオリジン制約とCORS / 2.9.1](#2101-クロスオリジン制約とcors--291)
    - [2.10.2. セキュリティモデルとSSLの関係 / 2.9.2](#2102-セキュリティモデルとsslの関係--292)

# 1. JavaScript Level 1 出題範囲

## 1.1. JavaScriptの基礎 / 2.1.1
...
### 1.6.2. フォームの操作とバリデーション / 2.2.2 (一部)
出題種別: 知識問題、コードリーディング問題、記述問題
...
### 1.8.1. マルチメディア・グラフィックス系API / 1.5.1
出題種別: 知識問題、コードリーディング問題、記述問題
...
## 2.3. グラフィックス・アニメーション / 1.5.1

### 2.3.1. Canvas(2D) / 2.3.1
出題種別: 知識問題、コードリーティング問題、記述問題
...
## 2.4. グラフィックス・アニメーション / 1.5.1

### 2.4.1. Canvas(2D) / 2.3.1
出題種別: 知識問題、コードリーティング問題、記述問題
...
### 2.4.3. Timing control for script-based animations / 2.3.3
出題種別: 知識問題、コードリーティング問題、記述問題
...
### 2.5.2. DeviceOrientation Event / 2.7.2
出題種別: 知識問題、コードリーティング問題、記述問題
...
### 2.6.2. Indexed Database API / 2.5.2
出題種別: 知識問題、コードリーティング問題、記述問題
...
### 2.7.3. Server-Sent Events / 2.6.3
出題種別: 知識問題、コードリーティング問題、記述問題
...
### 2.8.2. DeviceOrientation Event / 2.7.2
出題種別: 知識問題、コードリーティング問題、記述問題
...
### 2.9.2. High Resolution Time / 2.8.2
出題種別: 知識問題、コードリーティング問題、記述問題
...
### 2.9.3. Service Workerによるオフラインアプリケーション / 2.8.3
出題種別: 知識問題、コードリーティング問題、記述問題
