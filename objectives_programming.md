...
- [2. JavaScript Level 2 出題範囲](#2-javascript-level-2-出題範囲)
  - [2.1. 高度なJavaScript](#21-高度なjavascript)
    ...
    - [2.1.2. 関数とコレクションの高度な操作](#212-関数とコレクションの高度な操作)
    - [2.1.3. 高度な非同期・平行パターン](#213-高度な非同期平行パターン)
  ...
  - [2.9. パフォーマンスAPI](#29-パフォーマンスapi)
    - [2.9.1. パフォーマンスタイミングAPI](#291-パフォーマンスタイミングapi)
    - [2.9.2. ナビゲーションとリソースタイミング](#292-ナビゲーションとリソースタイミング)
