...
| 編成 | 重要度は出題バリエーションの多さとどう両立させるか？ | Markup | 学習上必須でも問題の切り口が限られる領域は、重要度を相対的に下げてよい（仮見解）。例: カスケードと継承は v2.5 1.2.3 で重要度2。新試験でも継承追加後は4としていたが、出題バリエーションの観点から3に下げる。 | v2.5 objectives_level1.md 1.2.3=(2) | 解決 |
